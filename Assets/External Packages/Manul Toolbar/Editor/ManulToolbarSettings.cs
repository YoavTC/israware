...
namespace Manul.Toolbar
{
	...
	public class ManulToolbarSettings_Editor : UnityEditor.Editor
	{
	...
	static class ManulToolbar
	{
				...
				case ToolbarButtonType.ObjectOfTypeMethod:
					...
					return () =>
					{
                        ...
                        UnityEngine.Object[] objects =
                            UnityEngine.Object.FindObjectsByType(actionClass, FindObjectsSortMode.None);
		...
		{
			System.Type projectWindowType = typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.ProjectBrowser");
